...
module.exports = {
    ...
    validateProof(hash, data){
        ...
        if(Object.hasOwn(data.witness, 'closedroot')){
            const finalroot = module.exports.calculateTree([yearsHash, otherroot]);
        } else {
            const finalroot = module.exports.calculateTree([otherroot, yearsHash]);
        }

        return (finalroot == mkcalroot);
