...
class MerkleCalendar {
    ...
    addRegistration(name, hash, year, month, day, hour, minute, second, closed, storageGroup) {
        let tree = this.#open;
        if (closed) {
            tree = this.#closed;
        }
    ...
    addRegistrationD(name, hash, date, closed, storageGroup) {
    ...
    addRegistrationNC(name, hash, year, month, day, hour, minute, second, closed, mHash, yHash, storageGroup) {
        let tree = this.#open;
        if (closed) {
            tree = this.#closed;
        }
    ...
    createLeaf(name, year, month, day, hour, minute, second, hash, monthNode, storageGroup) {
            ...
            for (month of year.getChildren()) {
                for (leaf of month.getChildren()) {
                    ...
                    openA.push({
                        ...
                        hash: leaf.getHash(),
                        storageGroup: leaf.getStorageGroup()
                    });
                }
            }
        }
