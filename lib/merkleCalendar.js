...
class MerkleCalendar{
    ...
    addRegistration(name, hash, year, month, day, hour, minute, second, closed){
        ...
        let leaf = this.createLeaf(name, day, hour, minute, second, hash, monthNode);
    ...
    createLeaf(name, day, hour, minute, second, hash, monthNode){
        let newHash = conmbineHash(day, hour, minute, second, hash);
