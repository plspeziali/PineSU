    ...
    const questions = [
      {
        ...
        choices: [ 'Create new SU', 'Register SU in the blockchain network', 'Check SU integrity', 'Export files from current SU', 'Check files integrity', 'Custom Git command', 'Get / Change identity', 'Exit' ],
