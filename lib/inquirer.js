    ...
    const questions = [
      {
        ...
        choices: [ 'Create new SU / Recalculate open SU', "Stage Storage Unit for Synchronization", "Close current SU", 'Register SU in the blockchain network', 'Check SU integrity', 'Export files from current SU', 'Check files integrity', 'Custom Git command', 'Get / Change Wallet Addresses', 'Exit' ],
