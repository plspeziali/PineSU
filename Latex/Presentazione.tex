...
\begin{frame}
	\frametitle{Excursus su Git}
	Funzioni non invertibili che permettono di associare in maniera “univoca” stringhe di caratteri (e quindi anche documenti di varia natura tradotti in stringhe) a delle stringhe alfanumeriche di lunghezza fissa.
	\bigskip
	\begin{figure}
...
\begin{frame}
	...
	\begin{figure}
		\includegraphics[width=0.89\textwidth]{figures/async.png}
	\end{figure}
